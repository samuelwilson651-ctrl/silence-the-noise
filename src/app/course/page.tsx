...
export const metadata: Metadata = { title: "The Course | Silence the Noise™" };
...
export default function Page() {
  return (
    <div style={{ minHeight: "70vh", background: "#faf7f2", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: "1.5rem", padding: "6rem 2rem", textAlign: "center" }}>
      ...
      <h1 style={{ fontFamily: "var(--font-cormorant,Georgia,serif)", fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 600, color: "#0f1e35", margin: 0 }}>The Course</h1>

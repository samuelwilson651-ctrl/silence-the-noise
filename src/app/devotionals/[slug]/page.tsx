...
export const metadata: Metadata = {
  title: "Devotional | Silence the Noise™",
};

export default function DevotionalSlugPage({ params }: { params: { slug: string } }) {
  return (
    <div style={{ background: "#faf7f2", minHeight: "70vh", padding: "6rem 2rem" }}>
      <div style={{ maxWidth: 680, margin: "0 auto", textAlign: "center" }}>
        ...
        <p style={{ fontFamily: "var(--font-cormorant,Georgia,serif)", fontStyle: "italic", fontSize: "1.05rem", color: "#6b6256", margin: "0 0 2.5rem", lineHeight: 1.8 }}>
          This devotional is being prepared for publication. Please check back soon.
        </p>
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="/devotionals" className="btn btn-gold">All Devotionals →</Link>
          <a href="https://devotional-discovery.lovable.app" target="_blank" rel="noopener noreferrer" className="btn btn-outline-dark">Open Devotional App ↗</a>
        </div>
      </div>
    </div>
  );
